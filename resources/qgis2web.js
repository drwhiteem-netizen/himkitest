...
map.getView().fit([4168004.554434, 7544754.889200, 4176301.248526, 7549907.839770], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Интерактивная карта. Химки-2026. [ЕМ]</h2>';
        return titleElement;
    })(),
