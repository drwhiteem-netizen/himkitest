...
lyr__4.set('fieldAliases', {'name': 'name', 'skpdi': 'skpdi', 'description': 'description', 'fill': 'fill', 'fill-opacity': 'fill-opacity', 'stroke': 'stroke', 'stroke-width': 'stroke-width', 'stroke-opacity': 'stroke-opacity', });
...
lyr__4.set('fieldImages', {'name': 'TextEdit', 'skpdi': 'TextEdit', 'description': 'TextEdit', 'fill': 'TextEdit', 'fill-opacity': 'TextEdit', 'stroke': 'TextEdit', 'stroke-width': 'TextEdit', 'stroke-opacity': 'Range', });
...
lyr__4.set('fieldLabels', {'name': 'no label', 'skpdi': 'no label', 'description': 'no label', 'fill': 'no label', 'fill-opacity': 'no label', 'stroke': 'no label', 'stroke-width': 'no label', 'stroke-opacity': 'no label', });
